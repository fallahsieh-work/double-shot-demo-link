...
| # | 驗證項目 | 預期結果 | 結果 |
|---|---------|---------|------|
| 1 | 素材 1 是否正確顯示 | 寬度 100%，高度隨素材比例 | ✅ 通過 |
| 2 | 滑動後素材 2 sticky banner 是否出現 | 螢幕頂端顯示 320x100 | ✅ 通過 |
| 3 | 素材 3 GIF 掉落動畫 | 從頂部掉落至底部 | ✅ 通過 |
| 4 | 素材 4 底部滑出 | 從螢幕底部向上滑出 | ✅ 通過 |
| 5 | Creative 是否需要特定 DOM 結構 | 不需要 | ✅ 不需要 |
| 6 | Creative 是否需要額外 JS SDK | 不需要 | ✅ 不需要 |
